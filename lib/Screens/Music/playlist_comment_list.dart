...
class PlaylistCommentList extends StatefulWidget {
  final scrollController;
  final MangoPlaylist mangoPlaylist;
  const PlaylistCommentList(
      {Key? key, this.scrollController, required this.mangoPlaylist})
      : super(key: key);

  @override
  _PlaylistCommentListState createState() => _PlaylistCommentListState();
}

class _PlaylistCommentListState extends State<PlaylistCommentList> {
  ...
  Widget build(BuildContext context) {
    final comments = Provider.of<List<MangoPlaylistComment>>(context);
  ...
  StreamBuilder<MangoUser?> mainPost(MangoPlaylistComment? post) {
...
class PostItem extends StatefulWidget {
  ...
  final MangoPlaylistComment post;
...
class _PostItemState extends State<PostItem> {
  ...
  Widget build(BuildContext context) {
    ...
    return !widget.post.repost
                      ...
                      children: [
                        StreamBuilder<bool?>(
                            ...
                            builder: (BuildContext context,
                              ...
                              return InkWell(
                                  onTap: () async {
                                    widget._postService.likeBook(widget.post.id,
        ...
        : FutureBuilder(
            future: widget._postService
                .getBookCommentById(widget.post.repliedCommentID),
            builder:
