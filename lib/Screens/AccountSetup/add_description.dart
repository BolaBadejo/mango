...
import '../Profile/professions.dart';

class AddDetails extends StatefulWidget {
  final String? userId;
  const AddDetails({Key? key, required this.userId}) : super(key: key);
                                ...
                                Column(
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: user.data!.hobbies.isNotEmpty ? Column(
                                        children: [
                                          Wrap(
...
// Allows you to get a list of all the ItemTags
  ...
  Future pickFromGallery(BuildContext context, int type) async {
    ...
    setState(() {
      ...
      if (type == 1) {
        _bannerImage = file;
        UserService().updateBannerImage(file);
        pickedBanner = true;
      }
    });
  }
