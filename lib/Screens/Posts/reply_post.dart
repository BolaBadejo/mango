...
class ReplyMessage extends StatefulWidget {
  MangoPost post;
  ReplyMessage({Key? key, required this.post}) : super(key: key);
...
class _ReplyMessageState extends State<ReplyMessage> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<MangoUser?>(
        initialData: _user,
        stream: _userService.getUserInfo(widget.post.postCreator),
        builder:
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            TextButton(
                              onPressed: () async {
                                _postService.replyPost(titleController.text.trim(), returnedFile, widget.post);
                                UserService().sendNotification(widget.post, 'post',"@${snapshot.data!.username} commented on your post", "Post Activity", widget.post.postCreator, snapshot.data!.fcmToken);
